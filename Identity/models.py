...
class User(user_models.AbstractUser):
    ...
    portrait = models.ImageField(upload_to='images/', null=True, blank=True, verbose_name=(vn_identity.PORTRAIT))
    mobile = models.CharField(max_length=11, null=True, blank=True, verbose_name=(vn_identity.MOBILE))
    ...
    is_student = models.BooleanField(default=False, verbose_name=(vn_identity.IS_STUDENT))
    is_teacher = models.BooleanField(default=False, verbose_name=(vn_identity.IS_TEACHER))
    military_service = models.IntegerField(choices=MilitaryChoices.choices, null=True, blank=True, verbose_name=(vn_identity.MILITARY_SERVICE))
