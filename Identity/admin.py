...
class UserAdmin(admin.ModelAdmin):
    list_display = ('unique_code', 'username', 'email', 'first_name', 'last_name',
...
class StudentAdmin(admin.ModelAdmin):
    list_display = ('unique_code', 'user', 'entry_year',
...
class TeacherAdmin(admin.ModelAdmin):
    list_filter = ('unique_code','user', 'level', 'expert')
    list_filter = ('user__unique_code','user', 'level', 'expert')
