...
class EnrollmentAdmin(admin.ModelAdmin):
    ...
    search_fields = ('term', 'student', 'teacher_assistant', 'status', 'taken_term_number')
    # search_fields = ('student__username', 'teacher_assistant__username', 'term__name')
...
class StudentCourseAdmin(admin.ModelAdmin):
    ...
    search_fields = ('course_term', 'student', 'status', 'score')
    # search_fields = ('student__username', 'course_term__name')
