...
class StudentRequest(models.Model):
    ...
    course_term = models.ForeignKey(
        'EduTerm.CourceTerm', on_delete=models.PROTECT, verbose_name=vn_edurequest.STUDENT_REQUEST_COURSE_TERM)
    ...
    user_answer = models.ForeignKey(
        'Identy.User', on_delete=models.PROTECT, user_answer=vn_edurequest.STUDENT_REQUEST_USER_ANSWER)
