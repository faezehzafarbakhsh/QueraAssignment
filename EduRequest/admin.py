...
class StudentRequestAdmin(admin.ModelAdmin):
    list_display = ('student', 'term', 'course_term', 'status',
                    'request_type', 'has_academic_year')
    list_filter = ('student', 'term', 'course_term', 'status',
                   'request_type', 'has_academic_year')
    search_fields = ('student__username', 'term__name', 'course_term__name',
                     'status', 'request_type', 'has_academic_year')
...
class EnrollmentCertificateAdmin(admin.ModelAdmin):
    ...
    search_fields = ('student__username', 'term__name',
                     'enrollment_certificate_place')
